export const projects = [
    {
        ...
        image: '/images/language-learning-app/icon.png',
        images: [
            '/images/language-learning-app/login.png',
            '/images/language-learning-app/dashboard.png',
            '/images/language-learning-app/gen-vocab.png',
            '/images/language-learning-app/vocabulary.png',
            '/images/language-learning-app/vocab-list.png',
            '/images/language-learning-app/edit-vocab.png',
            '/images/language-learning-app/del-vocab.png',
            '/images/language-learning-app/gen-quiz.png',
            '/images/language-learning-app/quiz.png',
            '/images/language-learning-app/analytics.png',
        ],
    ...
    },
    {
        ...
        image: '/images/file-sync-app/icon.png',
        images: [
    ...
    },
    {
        ...
        categories: ['full stack'],
        image: '/images/ticket-system/icon.png',
        images: [
            '/images/ticket-system/tickethub-login.png',
            '/images/ticket-system/tickethub-dashboard.png',
            '/images/ticket-system/tickethub-event.png',
            '/images/ticket-system/tickethub-seats.png',
            '/images/ticket-system/tickethub-waiting-queue.png',
            '/images/ticket-system/tickethub-purchase-ticket.png',
            '/images/ticket-system/tickethub-my-ticket.png',
        ],
    ...
    },
    {
        ...
        categories: ['AI'],
        image: '/images/mcp-pr-workflow-server/icon.png',
        images: [
            '/images/mcp-pr-workflow-server/mcp-pr-workflow-server.gif',
            '/images/mcp-pr-workflow-server/mcp-pr-workflow-server-2.gif',
        ],
    ...
    },
    {
        ...
        categories: ['full stack'],
        image: '/images/my-shelf/icon.png',
        images: [
    ...
    },
    {
        ...
        image: '/images/newsletter-triage/icon.png',
        images: [
            '/images/newsletter-triage/newsletter-triage.png',
            '/images/newsletter-triage/newsletter-alerts.png',
        ],
    ...
    },
    {
        ...
        categories: ['Python'],
        image: '/images/stock-monitor-bot/icon.png',
        images: [
            '/images/stock-monitor-bot/stock-monitor-bot.png',
            '/images/stock-monitor-bot/stock-alerts.png',
        ],
    ...
    },
    {
        ...
        categories: ['full stack'],
        image: '/images/booking-app/icon.png',
        images: [
            '/images/booking-app/booking-page.png',
            '/images/booking-app/admin-dashboard.png',
            '/images/booking-app/test-dashboard.png',
            '/images/booking-app/confirm-booking.png',
            '/images/booking-app/confirmation.png',
            '/images/booking-app/upcoming-booking.png',
        ],
    ...
    },
    {
        ...
        categories: ['full stack'],
        image: '/images/ecommerce-app/icon.png',
        images: [
            '/images/ecommerce-app/front-page.png',
            '/images/ecommerce-app/jackets.png',
            '/images/ecommerce-app/jacket-loved.png',
            '/images/ecommerce-app/wishlist.png',
            '/images/ecommerce-app/checkout-page.png',
            '/images/ecommerce-app/card-details.png',
            '/images/ecommerce-app/payment-success.png',
        ],
